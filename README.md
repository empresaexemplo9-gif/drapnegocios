...
> Projeto **autônomo**: vive neste repositório `viajebrasil`, com seu próprio
> gerenciamento de dependências (npm) e ciclo de deploy independente do sistema
> contábil (`contabil-pro`).
...
2. Mantenha o **Root Directory** na raiz do repositório.
